export default [
    {
      ...
      css: 'url(https://i.imgur.com/3ksZB9Nr.jpg),linear-gradient(to top, #a8edea 0%, #fed6e3 100%)',
      height: 200
    },
    {
      name: 'Apex- Imobiliaria',
      description: 'Imobiliaria',
      css: 'url(https://i.imgur.com/52vtSIv.jpg),linear-gradient(120deg, #e0c3fc 0%, #8ec5fc 100%)',
      height: 400
    },
    // {
    //   name: 'Deep Blue',
